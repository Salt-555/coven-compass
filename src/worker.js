        ...
        <div class="demo-inner">
          ...
          <div id="demoResults" class="demo-results">
            ...
            <div style="display:flex;align-items:center;justify-content:center;">
              <a href="https://buy.stripe.com/eVq9AT27O3Ae17xgIB8g007" class="cta-btn" style="padding:10px 20px;font-size:11px;text-decoration:none;display:inline-block;">Unlock All 7 Categories</a>
            </div>
          </div>
        </div>
      </div>
